...
import { ArrowLeft, Tag, Percent, DollarSign, Calendar, RefreshCw, Globe } from 'lucide-react-native';
...
export default function AdminCreatePromotionScreen({ navigation, route }: any) {
  ...
  const handleSave = async () => {
    ...
    if (isEditing) {
      ...
      result = await createPlatformPromotion(input);
    }
    ...
    if (result.error) {
      ...
      Alert.alert('Success', isEditing ? 'Promotion updated!' : 'Platform promotion created!', [
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>
          {isEditing ? 'Edit Platform Promo' : 'New Platform Promo'}
        </Text>
        <TouchableOpacity
      ...
      >
        ...
        <View style={styles.platformBanner}>
          ...
          <Text style={styles.platformBannerText}>
            This promotion is platform-wide and applies to all professionals.
          </Text>
        </View>
        ...
        <Card style={styles.section}>
          ...
          <View style={styles.codeRow}>
            <TextInput
              ...
              placeholder="e.g. PLATFORM20"
              placeholderTextColor={COLORS.textLight}
              autoCapitalize="characters"
              maxLength={20}
            />
            <TouchableOpacity style={styles.generateButton} onPress={() => setCode(generateCode())}>
        ...
        <Card style={styles.section}>
          ...
          <TextInput
            ...
            placeholder="e.g. Grand Launch Sale"
            placeholderTextColor={COLORS.textLight}
          />
