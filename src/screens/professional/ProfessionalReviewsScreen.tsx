...
export default function ProfessionalReviewsScreen({ navigation }: any) {
  const { user } = useAuth();
      ...
      <View style={styles.reviewHeader}>
        <View style={styles.reviewerInfo}>
          ...
          <View style={styles.reviewerDetails}>
            <Text style={styles.reviewerName}>{review.reviewer?.name || 'Client'}</Text>
        ...
        <View style={styles.reviewsSection}>
          ...
          {reviews.length === 0 ? (
            <EmptyState
              ...
              description="Your client reviews will appear here once they leave feedback"
            />
          ) : (
